...
function HomeRedirect() {
  ...
  const homePath = user.role === "STAFF" ? "/products" : "/dashboard";
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AdminLayout />}>
          ...
          <Route element={<RoleRoute allowedRoles={["ADMIN", "MANAGER", "STAFF"]} />}>
            ...
            <Route path="/stock-ins" element={<StockInListPage />} />
            <Route path="/stock-ins/create" element={<StockInCreatePage />} />
            <Route path="/stock-ins/:id" element={<StockInDetailPage />} />

            <Route path="/stock-outs" element={<StockOutListPage />} />
            <Route path="/stock-outs/create" element={<StockOutCreatePage />} />
            <Route path="/stock-outs/:id" element={<StockOutDetailPage />} />
          ...
          <Route element={<RoleRoute allowedRoles={["ADMIN", "MANAGER"]} />}>
            ...
            <Route path="/storage-pricing" element={<StoragePricingPage />} />
            ...
            <Route path="/gates" element={<GateListPage />} />
